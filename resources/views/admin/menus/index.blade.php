            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div
                    ...
                    <div class="w-full md:w-1/2 ">
                        <h3 class="text-gray-600 font-bold"> Liste des menus</h3>
                    </div>
                    <div
                            ...
                            @foreach ($menus as $menu)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="menu-{{ $menu->id }}-dropdown-button"
                                            data-dropdown-toggle="menu-{{ $menu->id }}-dropdown"
                                        ...
                                        <div id="menu-{{ $menu->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <li>
                                                    <a href="#"
                                                        onclick="event.preventDefault(); document.getElementById('del-menu-{{ $menu->id }}').submit()"
                                                        class="flex
