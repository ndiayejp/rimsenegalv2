            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div
                    ...
                    <div class="w-full md:w-1/2 ">
                        <h3 class="text-gray-600 font-bold"> Liste des users</h3>
                    </div>
                    <div
                            ...
                            @foreach ($users as $user)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end gap-2">
                                        ...
                                        <a href="#"
                                            onclick="event.preventDefault(); document.getElementById('del-user-{{ $user->id }}').submit()"
                                            class="rounded flex
                                            ...
                                            <form action="{{ route('admin.users.destroy', $user) }}"
                                                style="display:none" method="POST" id="del-user-{{ $user->id }}">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </a>
