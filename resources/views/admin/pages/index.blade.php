                        ...
                        <tbody>
                            @foreach ($pages as $page)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 max-w-[12rem] truncate"> {{ $page->created_at }}</td>
                                    <td class="px-4 py-3">
                                        <label class="inline-flex items-center cursor-pointer">
                                            <input type="checkbox" value="" class="sr-only peer" checked disabled>
                                            <div
                                                class="relative w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 {{ $page->status === 1 ? 'peer-checked:bg-green-600' : 'peer-checked:bg-gray-300' }}">
                                            </div>
                                        </label>
                                    </td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="page-{{ $page->id }}-dropdown-button"
                                            data-dropdown-toggle="page-{{ $page->id }}-dropdown"
                                        ...
                                        <div id="page-{{ $page->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <li>
                                                    <a href="#"
                                                        onclick="event.preventDefault(); document.getElementById('del-page-{{ $page->id }}').submit()"
                                                        class="flex
