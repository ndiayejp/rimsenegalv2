<h3 class="text-gray-700 text-xl font-bold my-5 px-3 lg:px-0">{{ __('Rechercher') }}</h3>
<form action="{{ route('blog.search') }}" class="max-w-md mx-auto px-1 lg:px-0" method="GET">
