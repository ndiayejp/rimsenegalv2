<x-panel>
    <div class="flex justify-between items-center mb-5 text-gray-500 ">
        <span
            class="bg-gray-100 text-gray-400 text-xs font-medium inline-flex justify-center gap-2 items-center p-1.5 rounded dark:bg-primary-200 dark:text-primary-800">
            {{ $post->category->name }}
        </span>
    ...
    <div class="grid grid-rows-subgrid ">
        ...
        <div class="flex justify-end items-center">
            <a href="{{ route('post.show', $post->getSlug()) }}"
                class="inline-flex gap-2   group-hover:bg-secondary group-hover:border-primary border-primary rounded-full px-2.5 py-1.5 items-center font-medium text-primary dark:text-primary-500">
                Lire la suite
